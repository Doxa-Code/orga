...
import { cn, compareStrings } from "@orga";
      ...
      <SelectContent position="popper" align="start" className="w-[282px] p-0">
        ...
        >
          {props.noSearchInput ? null : (
            <div className="border border-gray-300 bg-background px-2 py-3">
              <CommandInput
                ref={inputSearchRef}
                className="bg-whte rounded border border-gray-300 p-2 font-light text-slate-800"
              />
            </div>
          )}
          <CommandList>
