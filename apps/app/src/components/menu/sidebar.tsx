...
import { ScrollArea } from "@orga/ui/scroll-area";
...
export const modules: Module[] = [
  ...
  //   ),
  //   Module.create("Orçamentos", "Budget", "/budgets", "Módulo de agendamento"),
  //   Module.create(
  //     "Estoque",
  //     "Stock",
  //     "/stock",
  ...
  return (
    <ScrollArea>
      <div className="px-4 sticky bg-white top-0 py-8">
        <Logo className="text-2xl text-primary">Budget</Logo>
